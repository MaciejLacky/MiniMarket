...
namespace MiniMarket.Model.EntitiesForView
{
    public class MagazynForView
    {
        ...
        public Nullable<decimal> Twr_WartoscCenaSprNetto { get; set; }
        public Nullable<decimal> Twr_WartoscCenaZakNetto { get; set; }
